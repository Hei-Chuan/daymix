...
新增宗教、哲学、历法或占卜资料时，必须提交：标题、作者或传统归属、年代、URL、许可证或公版依据（必要时说明地区）、与项目范围的关系、预期用途及受影响文件。先更新 `references/sources.yaml` 和 `SOURCES.md`。版权不清的全文、现代译文、图片与数据集不得打包；没有来源的“网上说法”不进入核心资料。
