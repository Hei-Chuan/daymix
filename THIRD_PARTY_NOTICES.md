...
| --- | --- | --- | --- | --- | --- |
| `lunar-python` (`lunar_python`) | 1.4.8 | Lunar, sexagenary, solar-term and almanac calculations | [6tail/lunar-python](https://github.com/6tail/lunar-python) | [`lunar-python-LICENSE`](skills/daymix/vendor/licenses/lunar-python-LICENSE) | No |
| `astronomy-engine` (`astronomy`) | 2.1.19 | v2 geocentric positions and aspects; v1 solar longitude and Moon–Sun angle | [cosinekitty/astronomy](https://github.com/cosinekitty/astronomy) | [`astronomy-engine-LICENSE`](skills/daymix/vendor/licenses/astronomy-engine-LICENSE) | No |
