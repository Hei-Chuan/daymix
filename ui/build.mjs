...
const result=await build({entryPoints:[new URL('./card.js',import.meta.url).pathname],bundle:true,format:'iife',write:false,minify:true,target:'es2020',platform:'browser'});
